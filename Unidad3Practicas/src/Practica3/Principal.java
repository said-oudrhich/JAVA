...
public class Principal {
    public static void main(String[] args) {
        ...
        suma1 = (entidad / 1000) * 4;          
        suma1 += ((entidad / 100) % 10) * 8;    
        suma1 += ((entidad / 10) % 10) * 5;     
        suma1 += (entidad % 10) * 10;           

        suma1 += (oficina / 1000) * 9;           
        suma1 += ((oficina / 100) % 10) * 7;     
        suma1 += ((oficina / 10) % 10) * 3;      
        suma1 += (oficina % 10) * 6;
        ...
        // Calcular segundo dígito de control (cc2)
